<template>
  <div>
    ...
    <div class="comment-item p-4 border-b border-gray-200">
      <img v-if="props.photoUrl" :src="props.photoUrl" alt="Profile picture" class="object-cover rounded-full w-10 h-10 border-4 border-gray-800 mr-2 cursor-pointer"
    ...
    <div class="replies pl-8 mt-2 mb-2" v-if="props.replies && props.replies.length">
      <div v-for="reply in props.replies" :key="reply.commentId" class="reply-item p-2 border-b border-gray-100">
        <img v-if="reply.photoUrl" :src="reply.photoUrl" alt="Profile picture" class="object-cover rounded-full w-8 h-8 border-2 border-gray-700 mr-2 cursor-pointer"
