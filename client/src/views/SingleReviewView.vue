    ...
    <main>
        <div class="text-center">
            ...
            <div v-else-if="posts && posts.length">
                <div v-for="post in posts" :key="post.reviewId">
                <ReviewCard :reviewItems="post" :highlightCommentId="singleCommentId" />
                </div>
            </div>
            <div v-else>
                <p class="text-center">Her skjedde det noe merkelig</p>
            </div>
        </div>
    </main>
  </template>
